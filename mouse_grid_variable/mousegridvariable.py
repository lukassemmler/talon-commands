# original code by https://github.com/timo/ at https://github.com/timo/talon_scripts 
# based on https://github.com/knausj85/knausj_talon/blob/master/mouse_grid/mouse_grid.py
...
narrow_expansion = mod.setting(
    "grid_variable_narrow_expansion",
    type=int,
    default=0,
